...
A starter for a single micro-learning module. Every repo created from this template arrives already wired to the team standard — no setup required.
...
Add your module's HTML/CSS/JS. Copilot will hold the work to the standard above as you go. Before shipping, the standard's own review checklist (Part 3) is the definition of done.
